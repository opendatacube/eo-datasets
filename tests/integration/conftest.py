...
def expected_l1_ls8_folder(
    ...
    if collection == "2":
        processing_datetime = datetime(2020, 9, 7, 19, 30, 5, tzinfo=timezone.utc)
        cloud_cover = 93.28
        points_model = 125
        points_version = 5
        rmse_model_x = 4.525
        ...
        processing_datetime = datetime(2017, 4, 5, 11, 17, 36, tzinfo=timezone.utc)
        cloud_cover = 93.22
        points_model = 66
        points_version = 4
        rmse_model_x = 4.593
    ...
    return {
        ...
        "properties": {
            "datetime": datetime(2016, 1, 21, 23, 50, 23, 54435, tzinfo=timezone.utc),
...
def l1_ls7_tarball_md_expected(
    ...
    return {
        ...
        "crs": "epsg:32652",
        "properties": {
            "datetime": datetime(2013, 4, 29, 1, 10, 20, 336_104, tzinfo=timezone.utc),
            "odc:dataset_version": "1.0.20161124",
            "odc:file_format": "GeoTIFF",
            "odc:processing_datetime": datetime(
                2016, 11, 24, 8, 26, 33, tzinfo=timezone.utc
            ),
...
def l1_ls5_tarball_md_expected(
    ...
    return {
        ...
        "crs": "epsg:32655",
        "properties": {
            "datetime": datetime(1997, 4, 6, 23, 17, 43, 102_000, tzinfo=timezone.utc),
            "odc:dataset_version": "1.0.20161231",
            "odc:file_format": "GeoTIFF",
            "odc:processing_datetime": datetime(
                2016, 12, 31, 15, 54, 58, tzinfo=timezone.utc
            ),
            "odc:producer": "usgs.gov",
            "odc:product_family": "level1",
