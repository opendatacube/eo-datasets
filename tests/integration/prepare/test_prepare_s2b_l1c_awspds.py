...
def test_prepare_s2a_l1c_safe(tmpdir):
    ...
    expected_metadata_path = output_path / 'S2B_OPER_MSI_L1C_TL_EPAE_20180617T013729_A006677_T55JGF_N02.06.yaml'
    ...
    check_prepare_outputs(
        ...
        run_args=[
            ...
            str(output_path / 'S2B_OPER_MSI_L1C_TL_EPAE_20180617T013729_A006677_T55JGF_N02.06')
        ],
